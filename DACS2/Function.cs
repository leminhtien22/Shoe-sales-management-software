...
namespace DACS2
{
    public class Function
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = "Data Source=DESKTOP-D51HV0I;Initial Catalog=DoAn2;Integrated Security=True;Encrypt=False";
            Con.Open();
        }
        //kết nối CSDL
        ...
        public static string CreateKey(string tiento)//Tạo số hóa đơn theo ngày,giờ,tháng,năm
        {
            string key = tiento;
            string[] partsDay;
